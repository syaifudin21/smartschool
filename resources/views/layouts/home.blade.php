...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{url('materialize/css/materialize.css')}}"  media="screen,projection"/>
    <link type="text/css" rel="stylesheet" href="{{url('materialize/css/style.css')}}"  media="screen,projection"/>
